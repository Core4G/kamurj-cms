...
export interface ApiBranchBranch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workingFrom: Schema.Attribute.Time &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    workingTo: Schema.Attribute.Time &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCallBackRequestCallBackRequest
  ...
  info: {
    displayName: 'CallBackRequest';
    pluralName: 'call-back-requests';
    singularName: 'call-back-request';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    Contacted: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::call-back-request.call-back-request'
    > &
      Schema.Attribute.Private;
...
export interface ApiExchangeRateExchangeRate
  ...
  attributes: {
    ...
    sell: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.DefaultTo<0>;
    showInTable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiLoanGroupLoanGroup extends Struct.CollectionTypeSchema {
  collectionName: 'loan_groups';
  info: {
    displayName: 'LoanGroup';
    pluralName: 'loan-groups';
    singularName: 'loan-group';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    activeIconSrc: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
